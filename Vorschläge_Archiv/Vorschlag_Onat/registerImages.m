...
% Auto-generated by registrationEstimator app on 14-Jun-2021
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',752.314821,'NumOctaves',2,'NumScaleLevels',4);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',752.314821,'NumOctaves',2,'NumScaleLevels',4);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',34.722221,'MaxRatio',0.347222);
